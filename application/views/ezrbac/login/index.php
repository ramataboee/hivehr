...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="login-form" action="" method="post" id="form_login">
                ...
                <div class="alert alert-danger display-hide" id="allErrors"
                ...
                <div class="form-actions">
                    ...
                    <label class="rememberme check mt-checkbox mt-checkbox-outline">
                        <input type="checkbox" name="remember" value="1" <?php if ($this->input->post('remember')) echo 'checked="checked" '?> />Remember
                        <span></span>
                    </label>
